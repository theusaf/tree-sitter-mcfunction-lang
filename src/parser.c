...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [664] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_selector_option, 3), SHIFT(19),
  ...
  [683] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_nbt, 5),
  [685] = {.entry = {.count = 1, .reusable = true}}, SHIFT(241),
  [687] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [689] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_score, 5),
  [691] = {.entry = {.count = 1, .reusable = true}}, SHIFT(242),
  [693] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nbt_number, 2),
  ...
  [713] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__command_choices, 1), SHIFT(118),
  ...
  [722] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_score_value, 1),
  ...
  [730] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_key, 1),
  [732] = {.entry = {.count = 1, .reusable = true}}, SHIFT(243),
  [734] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_score_repeat1, 8),
  [736] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_nbt_repeat1, 8, .production_id = 4),
  [738] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_nbt_repeat1, 8),
  [740] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 4),
  [742] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__command_choices, 1), SHIFT(126),
  [745] = {.entry = {.count = 1, .reusable = true}}, SHIFT(133),
  [747] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_execute_command_repeat1, 2),
  [749] = {.entry = {.count = 1, .reusable = true}}, SHIFT(170),
  [751] = {.entry = {.count = 1, .reusable = true}}, SHIFT(169),
  [753] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_state_key, 1),
  [755] = {.entry = {.count = 1, .reusable = true}}, SHIFT(143),
  [757] = {.entry = {.count = 1, .reusable = true}}, SHIFT(126),
  [759] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_execute_keyword, 1),
